...
class DailyCoinStats(Base):
    ...
    max_supply = Column('max_supply', Numeric)
    fully_diluted_valuation = Column('fully_diluted_valuation', Numeric)
    coin_roi = Column('coin_roi', Numeric)
    market_cap = Column('market_cap', Numeric)
    market_cap_dominance = Column('market_dominance', Numeric)
    trading_volume = Column('trading_volume', Numeric)
    volume_market_cap = Column('volume_market_cap', Numeric)
    daily_low_high = Column('daily_low_high', ARRAY(Float))
    weekly_low_high = Column('weekly_low_high',ARRAY(Float))
    market_cap_rank = Column('market_cap_rank', Numeric)
    all_time_high = Column('all_time_high', Numeric)
    all_time_high_date = Column('all_time_high_date', Date)
    ath_percent_change = Column('ath_percent_change', Numeric)
